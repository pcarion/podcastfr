...
const Host: FC<HostProps> = ({ name, twitter, bgColor }): ReactElement => {
  return (
    <>
      <div className="flex flex-col ${textColor} ">
        ...
        {twitter != '_' && (
          <a
            type="button"
            className="inline-flex items-center mt-1 px-1 py-1 border border-transparent text-xs font-medium rounded-full shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          ...
          >
            ...
            >
              <g>
                <rect fill={bgColor} opacity="0.15" width="400" height="400" />
              </g>
              <g>
                <g>
                  <path
